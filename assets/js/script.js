  ...
  const projectContent = {
    ...
    "thorium-phosphates": `
      <div class="project-detail">
        ...
        <br>
        <h3>At a Glance: Scope, Techniques and Results</h3>
        <p>In this study, I was interested in the chemistry of nanoscale thorium dioxide (ThO<sub>2</sub>) in the presence of phosphate ions (PO<sub>4</sub><sup>3-</sup>). I synthesised nanoscale ThO<sub>2</sub> through reverse strike precipitation, then exposed it to hydrothermal high-phosphate solutions set to different pH values. I obtained a hydrated, previously uncharacterised ceramic.<br> I tested the material using <b>X-ray diffraction (XRD)</b>, <b>transmission electron microscopy (TEM)</b>,<b>energy-dispersive X-ray spectroscopy (EDS)</b>, <b>thermal gravimetric analysis (TGA)</b>, <b>extended X-ray absorption fine structure (EXAFS) spectroscopy</b>, <b>X-ray pair distribution function (PDF) analysis</b>, <b><sup>31</sup>P nuclear magnetic resonance (NMR)</b> spectroscopy, and <b>Fourier-transform infrared (FTIR) spectroscopy</b>.<br> I found that the hydrated phase has a consistent structure regardless of synthesis pH, but is able to trap different amounts of reagents in its channels. During calcination to 1000 degrees Celcius, the trapped reagents drive the formation of different crystalline thorium phosphate phases. I confirmed the identity of the crystalline final products using <b>X-ray diffraction</b> and <b>extended X-ray absorption fine structure (EXAFS) spectroscopy</b>. This finding reveals a new pathway for thorium immobilisation in phosphate ceramics.<br>In addition to the experimental work, I carried out extensive data analysis, including <b>Fourier transform</b> and <b>wavelet transform</b> processing of oscillatory signals and <b>Rietveld refinement</b> of XRD patterns. I managed this project over <b>1 year</b>, bringing together scientists from <b>4 scientific institutions</b>.</p>
        <br>
        ...
        chemistry in the thorium dioxide - phosphate system. Unexpectedly, we were able to expand on work done as far back as 1960s.</p>
        <p>We found that ThO<sub>2</sub>, exposed to high concentrations of phosphate, reformed into an unknown phase with a high water content. The structure of the phase could not be immediately determined. 
...
<a href = "https://doi.org/10.1016/S0020-1693(00)93352-8">https://doi.org/10.1016/S0020-1693(00)93352-8</a></p>
    ...
    "nu601-excited-state": `
      <div class="project-detail">
        ...
        <p>Metal-organic frameworks (MOFs) are modular materials composed of <span class="tooltip-container"><span class="tooltip-trigger">metal-oxo clusters</span><span class="tooltip-content">A nanosized structure composed of a small number of metal ions and oxygen atoms.</span></span> called nodes and organic molecules referred to as linkers. 
        One application for MOFs is <span class="tooltip-container"><span class="tooltip-trigger">light harvesting</span><span class="tooltip-content">Conversion of light into a useful form of energy.</span></span>. The term originates from natural photosynthesis, where light energy is captured by large collections of pigments. The linkers in a MOF can also be thought of as pigments. To predict if they would do well as light harvesters, we need to understand how they interact with light. I used a MOF called NU-601 as a test case.</p>
        <p>The figure below depicts a zirconium node, one of the secondary building units in NU-601. The node is composed of six zirconium atoms connected by oxygen atoms. In the image, it is depicted coated (<span class="tooltip-container"><span class="tooltip-trigger">ligated</span><span class="tooltip-content">Ligation refers to binding of small molecules to a metal ion.</span></span>) by a collection of acetate groups. Acetates are carboxylates, ions containing a carboxyl group (-COO<sup>-</sup>).</p>
        <figure>
        ...
        <p>The node, as depicted, has a formal chemical formula of Zr<sub>6</sub>O<sub>4</sub>(OH)<sub>4</sub>(CH<sub>3</sub>COO)<sub>12</sub>. The "(CH<sub>3</sub>COO)<sub>12</sub>" part describes the acetates. This acetate-ligated zirconium node representation was built from a crystal structure reported earlier.<sup>2</sup> The node is very stable: it is resistant to chemicals and heat. It is assumed to be <span class="tooltip-container"><span class="tooltip-trigger">insulating</span><span class="tooltip-content">Non-interactive in this context.</span></span> and not to interact with light very much. This assumption will be substantiated in a section below.</p>
        ...
        <p>The linker is a <span class="tooltip-container"><span class="tooltip-trigger">tetra-phenylcarboxylate</span><span class="tooltip-content">There are 4 carboxylate (COO) fragments on phenyl groups ("rings").</span></span>. The linker is sometimes referred to as iso-H<sub>4</sub>TBAPy. Just like the acetate, the linker is a carboxylate. Unlike the acetate, the linker has 4 carboxylate groups. Also, it does not bend. This means that the linker can connect (link) 4 nodes. The nodes, in turn, can bind up to 12 linkers (same as with acetates). In reality, this linker is too big, and 12 of them will not fit around the node.</p>
        ...
        <p>A representation of the framework is shown in the next figure.</p>
        <figure>
        ...
        <p>The importance of those hydroxyl and water groups is that they engender <span class="tooltip-container"><span class="tooltip-trigger">acid-base</span><span class="tooltip-content">Acids donate protons. Bases accept protons.</span></span> chemistry to the node. The H atoms in the hydroxo and water groups can dissociate as H<sup>+</sup>, and will do so if the environment is sufficiently alkaline.</p>
        <p><b>To recap</b>, NU-601 is a Zr-based MOF composed of Zr-based nodes and tetra-phenylcarboxylate linkers. Each linker is connected to 4 nodes. Each node supports 6 linkers with 6 more occupied by hydroxyl and water groups. The linkers and nodes align into a large, three-dimensional structure. When aqua and hydroxo groups are present on the node, they can lose their <span class="tooltip-container"><span class="tooltip-trigger">protons</span><span class="tooltip-content">A type of a subatomic particle. A hydrogen ion, H+, is a proton.</span></span> (H<sup>+</sup>) in alkaline conditions. This does not affect the linker-node connections.</p>
        ...
        <p>In the above discussion of NU-601's structure, we have observed that the formation of the framework locks a large collection of molecules - the linkers - into close proximity. Their rigid connections with the nodes hold them in place. They may absorb incoming light. Absorption of light usually boils down to an interaction between a molecule (or a cluster, like the node) and a photon. For absorption to occur, the energy of this photon needs to match an <span class="tooltip-container"><span class="tooltip-trigger">energy gap</span><span class="tooltip-content">Difference in potential energy.</span></span> between <span class="tooltip-container"><span class="tooltip-trigger">energy levels</span><span class="tooltip-content">Energy levels can be defined with respect to different standards; in general we are concerned with gaps.</span></span> present in the material. We talk about this in terms of <span class="tooltip-container"><span class="tooltip-trigger">ground state</span><span class="tooltip-content">Unexcited, i.e. "default" state of matter.</span></span> and <span class="tooltip-container"><span class="tooltip-trigger">excited state</span><span class="tooltip-content">State of matter with higher potential energy stemming from e.g. interaction with light.</span></span>; the difference in their energies is equal to that gap.<br>It turns out that the ground-excited energy gap for the zirconium node is far larger than that for the linker. If the ground and excited states were like banks of a river, and you wished to connect them with a bridge, you would find it much easier for the linker than for the node. As a result, a common assumption in zirconium MOF science is that the node is <span class="tooltip-container"><span class="tooltip-trigger">inert</span><span class="tooltip-content">Same as insulating. Non-interactive. Does not react.</span></span>. Very high energy light ("hard UV") would be required to excite it.<br>
        ...
        One simple method that can yield information about the excited state is <span class="tooltip-container"><span class="tooltip-trigger">fluorescence spectroscopy</span><span class="tooltip-content">An analytical measurement. How much does the material glow once it absorbs light?</span></span>. First, the material is excited with UV light. The excited state cannot exist indefinitely, so it eventually decays (relaxes) back to the ground state. This relaxation often results in light being emitted back. Glow-in-the-dark materials work on this principle.</p>
        ...
        <p>Therefore, in a fluorescence experiment, we first <i>excite</i> the material with <span class="tooltip-container"><span class="tooltip-trigger">monochromatic</span><span class="tooltip-content">Single-colour. Small handheld laser pointers are usually monochromatic.</span></span> UV light, then use a <span class="tooltip-container"><span class="tooltip-trigger">spectrometer</span><span class="tooltip-content">An analytical device that discerns energies contained in a signal.</span></span> to measure the signal, i.e. the light given off by the material. The signal can be described in terms of <span class="tooltip-container"><span class="tooltip-trigger">intensity</span><span class="tooltip-content">"Is it bright and easy to detect?".</span></span> and <span class="tooltip-container"><span class="tooltip-trigger">energy</span><span class="tooltip-content">"What colour is it? Is there enough energy to cross the energy gap?"</span></span>. Intensity describes the number of photons emitted, i.e. how bright the fluorescence is. The energy describes the colour of the fluorescence. Typically, the colours will be confined to a small region of the visible light spectrum. When multiple colours or hues are present, the <span class="tooltip-container"><span class="tooltip-trigger">monochromator</span><span class="tooltip-content">A device that selects a single colour (or energy) from many.</span></span> inside the <span class="tooltip-container"><span class="tooltip-trigger">fluorometer</span><span class="tooltip-content">A device that measures fluorescence.</span></span> will separate them. The fluorescence spectrum, therefore, is a statistical distribution and can be plotted on an x-y graph, where the x-axis describes energy (same as wavelength or colour) and the y-axis describes intensity (same as brightness or number of photons). In studies like this one, we are not interested in absolute intensity and want only the distribution, so spectra are often <span class="tooltip-container"><span class="tooltip-trigger">normalised</span><span class="tooltip-content">The process of putting data on the same relative scale.</span></span> to have a maximum intensity of 1 or 100%. The figure below shows normalised fluorescence spectra for the NU-601 MOF and the linker.</p> 
        <figure>
        ...
        <p>Therefore, we had a hypothesis, and a concrete prediction for what pH range we should cover. We needed experimental data. So I immersed the MOF into water and systematically changed the pH, causing protons (H<sup>+</sup>) to move between the surface of the node and the solution. These operations required precisely <span class="tooltip-container"><span class="tooltip-trigger">calibrated</span><span class="tooltip-content">Standardised, using well-defined reference materials.</span></span> pH measurements, careful weight measurements on an <span class="tooltip-container"><span class="tooltip-trigger">analytical balance</span><span class="tooltip-content">A very precise balance.</span></span>, and a lot of patience. The final dataset contained fluorescence spectra of the NU-601 MOF at 81 different pH values between ~2 (strongly acidic) and 9 (weakly basic). These spectra are reproduced below.</p>
        <figure>
        ...
        <h3>Bibliography</h3>
        <ul>
          <li>[1] Kramar, B. V.; Bondarenko, A. S.; Koehne, S. M.; Diroll, B. T.; Wang, X.; Yang, H.; Schanze, K. S.; Chen, L. X.; Tempelaar, R.; Hupp, J. T. Unexpected Photodriven Linker-to-Node Hole Transfer in a Zirconium-Based Metal–Organic Framework. J. Phys. Chem. Lett. 2024, 15 (46), 11496–11503. https://doi.org/10.1021/acs.jpclett.4c02848.
</li>
          <li>[2] Lu, Z.; Wang, R.; Liao, Y.; Farha, O. K.; Bi, W.; Sheridan, T. R.; Zhang, K.; Duan, J.; Liu, J.; Hupp, J. T. Isomer of Linker for NU-1000 Yields a New She-Type, Catalytic, and Hierarchically Porous, Zr-Based Metal–Organic Framework. Chem. Commun. 2021, 57 (29), 3571–3574. https://doi.org/10.1039/D0CC07974J.
</li>
          <li>[3] Klet, R. C.; Liu, Y.; Wang, T. C.; Hupp, J. T.; Farha, O. K. Evaluation of Brønsted Acidity and Proton Topology in Zr- and Hf-Based Metal–Organic Frameworks Using Potentiometric Acid–Base Titration. J. Mater. Chem. A 2016, 4 (4), 1479–1485. https://doi.org/10.1039/C5TA07687K.
</li>
        </ul>
      </div>
      `
